 ...
 */
    ...
    MON(NAM("siren"), S_NYMPH,
        LVL(8, 12, 9, 20, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_SING, AD_LURE, 0, 0), ATTK(AT_CLAW, AD_SEDU, 2, 4),
      	  ATTK(AT_TUCH, AD_WRAP, 0, 0), ATTK(AT_GAZE, AD_SLEE, 0, 0), NO_ATTK, NO_ATTK),
        SIZ(WT_NYMPH, 300, MS_SEDUCE, MZ_HUMAN), MR_SLEEP, 0,
        M1_HUMANOID | M1_FLY, M2_HOSTILE | M2_FEMALE, M3_INFRAVISIBLE,
        5, CLR_WHITE, SIREN),
